    ...
    >
      ...
      <section className="relative pt-32 pb-48 lg:pt-40 lg:pb-56 overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center lg:text-left w-full">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-6">Contact Us</h1>
            <p className="text-lg text-slate-700 dark:text-white/90 leading-relaxed max-w-2xl mx-auto lg:mx-0">
      ...
      <section className="relative -mt-32 pb-24 z-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-slate-50 dark:bg-[#061121] border border-slate-100 dark:border-white/5 shadow-2xl shadow-black/50 rounded-3xl overflow-hidden flex flex-col md:flex-row">
                
                {/* Left Side: Contact Info */}
                <div className="md:w-5/12 p-10 lg:p-14 border-b md:border-b-0 md:border-r border-slate-100 dark:border-white/5 flex flex-col justify-center">
                    <div className="space-y-12">
                        {/* Phone */}
                        <div className="flex items-center gap-5">
                            <div className="w-12 h-12 bg-[#23A8E0] rounded-[10px] flex items-center justify-center text-slate-900 dark:text-white flex-shrink-0 shadow-lg shadow-brand-primary/20">
                                <Phone className="w-5 h-5 fill-current" />
                            </div>
                            <div>
                                <h3 className="font-bold text-slate-600 dark:text-white/80 text-sm mb-1">Phone</h3>
                                <p className="text-slate-900 dark:text-white font-semibold tracking-wide">
                                    +971 56 71 38 911
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-600 dark:text-white/80 text-sm mb-1">E-mail</h3>
                                <p className="text-slate-900 dark:text-white font-semibold tracking-wide">
                                    info@gotorapid.com
                                </p>
                            </div>
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-600 dark:text-white/80 text-sm mb-1">Location</h3>
                                <p className="text-slate-900 dark:text-white font-semibold tracking-wide">
                ...
                {/* Right Side: Form */}
                <div className="md:w-7/12 p-10 lg:p-14 bg-slate-100 dark:bg-[#060D1A]">
      ...
      <section className="pb-32 w-full">
         <div className="w-full h-[500px] relative overflow-hidden bg-slate-50 dark:bg-[#061121] border-t border-b border-slate-100 dark:border-white/5 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-1000">
