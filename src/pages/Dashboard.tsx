    ...
    <div className="relative min-h-screen bg-brand-dark">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <div className="bg-surface-dark border border-white/5 p-6 rounded-2xl shadow-xl">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <p className="text-sm text-slate-400 font-medium tracking-wide">Active Invoices</p>
              <h3 className="text-2xl font-bold text-white">432</h3>
            </div>
          </div>
        ...
        <div className="bg-surface-dark border border-white/5 p-6 rounded-2xl shadow-xl">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <p className="text-sm text-slate-400 font-medium tracking-wide">Revenue</p>
        ...
        <div className="bg-surface-dark border border-white/5 p-6 rounded-2xl shadow-xl">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <p className="text-sm text-slate-400 font-medium tracking-wide">System Health</p>
              <h3 className="text-2xl font-bold text-white">99.9%</h3>
            </div>
          </div>
          <div className="text-sm font-medium text-slate-400 bg-white/5 px-2 py-1 rounded inline-block">All systems operational</div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
            ...
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-white text-sm font-medium">New integration configured for Western Europe region.</p>
                  <p className="text-slate-500 text-xs mt-1">2 hours ago by admin@rapid.com</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-surface-dark border border-white/5 p-8 rounded-3xl shadow-xl flex flex-col items-center text-center justify-center min-h-[300px]">
           ...
           <button className="flex items-center gap-2 text-brand-primary hover:text-white text-sm font-medium transition-colors">
